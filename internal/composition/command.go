...
func Start(ctx context.Context, o cli.StartOptions) (func() error, error) {
	...
	if managed {
		...
		cfg := fmt.Sprintf(`{"admin":{"listen":%q},"apps":{"http":{"servers":{"srv0":{"listen":[%q],"automatic_https":{"disable":true},"routes":[{"@id":"mirage-fallback","match":[{"path":["/*"]}],"handle":[{"handler":"static_response","status_code":404}],"terminal":true}]}}}}}`, adminListen, o.PublicAddress)
